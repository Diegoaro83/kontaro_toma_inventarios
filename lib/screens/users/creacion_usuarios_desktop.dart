...
/// 💻 VERSIÓN DESKTOP: CREACIÓN DE USUARIOS
///
/// Diseño con 2 columnas para aprovechar el espacio horizontal.
/// Formulario más compacto y eficiente para pantallas grandes.

class CreacionUsuariosDesktop extends StatelessWidget {
                      ...
                      Expanded(
                        child: _buildTextField(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () =>
                                onMostrarConfirmarContrasenaChanged(
                                  !mostrarConfirmarContrasena,
                                ),
                          ),
                          validator: (value) {
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(icono, color: const Color(0xFF7C3AED), size: 24),
        ),
